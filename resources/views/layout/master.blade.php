                ...
                <div class="col-md-12 col-lg-7 offset-lg-1 offset-xl-0">
                    <div class="hero-text">
                        <div class="hero-text-tablecell">
                            <p class="subtitle">Join Our Shop
                            </p>
                            <h1>Enjoy Our Sales</h1>
                            <div class="hero-btns">
                                <a href="shop.html" class="boxed-btn">join us</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-12">
                <p>Copyrights &copy; 2019 - <a href="https://imransdesign.com/">Osama Atef
                </p>
            </div>
